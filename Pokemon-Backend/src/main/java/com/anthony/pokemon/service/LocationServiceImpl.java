...
public class LocationServiceImpl implements LocationService {
    ...
    public void initializeLocations() {
        ...
        List<Location> newLocations = Arrays.asList(
                ...
                new Location("Battle Frontier", "The Battle Frontier in Pokémon HeartGold is a location north of Route 40 with various areas for testing your battling skills. Each area has different rules, and you earn Battle Points for every battle you win. These points can be exchanged for special prizes."),
                new Location("Indigo Plateau", "It is the final destination for Pokémon Trainers collecting Indigo or Johto League Badges. This is where the Trainers who have defeated all of the eight Gym Leaders of either Kanto or Johto battle against the Elite Four and the Pokémon Champion."),
                new Location("Shining Lighthouse", "Shining Lighthouse is the lighthouse located within Olivine City and uses the powers of Ampharos to help guide the ships to the city docks. However, the first joruney within it has the player discover Jasmine and find that the Ampharos is sick. After the SecretPotion is retrieved from Cianwood's pharmacy, Ampharos lights the way again. There are multiple trainers within the lighthouse"),
                new Location("Safari Zone Gate", "The Safari Zone is a special Pokémon preserve where Trainers can catch certain types of Pokémon. It is owned by Baoba, the owner of the former Kanto Safari Zone, which was, by then, made into a Pal Park by his son. However, Baoba later passes ownership of the Safari Zone onto the player."),

                new Location("Mt Silver", "Silver is a mountain in the northeast region of Johto, located west of Victory Road and the Indigo Plateau. It can be accessed via Route 28. It is where many high-level, wild Pokémon live, and since the area is so dangerous, it's off-limits to most Trainers."),
                new Location("Victory Road", "Victory Road is a cave in Pokémon HeartGold and SoulSilver that tests trainers' skills before they can reach the Pokémon League. It's named after the fact that all trainers must travel through it to reach the top."),
                new Location("Route 26", "Route 26 continues east on a bridge over a body of water just before the player is about to go north. When there is land, there are patches of grass manning wild Pokémon. As the player continues north, it will find a house where a woman offers to heal the trainer's entire team."),
                new Location("Route 27", "Route 27 begins as a water-logged route at its western terminus, requiring Trainers to surf east from New Bark Town to reach the first area of land along the route. After making landfall for the first time, a helpful Trainer near the shore will notify other Trainers that they have officially entered Kanto. The route continues east to a three-way intersection. The east path leads to the lower portion of a ledge and, ultimately, a dead end. The lack of a through route to the east forces Trainers to the north, where the path meets the western portal of the Tohjo Falls."),
                new Location("Tohjo Falls", "Located in southwest Kanto, it is the final test for Trainers who have acquired all eight Johto League Badges and wish to put their skills to the test against the Elite Four on Indigo Plateau to the north. The player will need their Pokémon to use the moves Surf and Waterfall to get through it. Because Trainers must obtain all the eight Johto League Badges to be granted access to the Pokémon League, the falls effectively hinder any progress on Route 27 until after the Trainer has found HM07 (Waterfall) at the Ice Path and received the Rising Badge from Clair in Blackthorn City."),
                new Location("Route 28", "From the Pokémon League Reception Gate, Route 28 heads southwest, passing through a gap in a ledge before turning west into a strip of tall grass containing wild Pokémon. The narrow strip, bordered at points by a pair of small ponds, turns north after passing a small pond to its north. Route 28 forms an upside down \"U\" at this point, returning west at the other end."),
                new Location("Route 22", "After departing Viridian City, Route 22 turns south at a line of trees before circling around the bottom of the treeline and passing north through a grassy patch of wild Pokémon. North of the patch, the route turns west, passing over a small hill as well as a small pond. Route 22 then turns south, hopping over a ledge into another patch of grass. Six paces to the south, Route 22 returns west, then north, passing through a hole in the fence outside the checkpoint building. To the northeast, the road goes through a break in a ledge before entering the building, emerging as Route 23 on the north side.")
        );
